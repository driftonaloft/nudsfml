...
import nudsfml.graphics.vertexarray;
...
class Text : Drawable, Transformable
{
     ...
     *
     * //deorecated: Use the 'characterSize' property instead.
     */
    //deorecated("Use the 'characterSize' property instead.")
     ...
     *
     * //deorecated: Use the 'fillColor' or 'outlineColor' properties instead.
     */
    //deorecated("Use the 'fillColor' or 'outlineColor' properties instead.")
     ...
     * 		newFont	= New font
     *
     * //deorecated: Use the 'font' property instead.
     */
    //deorecated("Use the 'font' property instead.")
     ...
     * Returns: Global bounding rectangle of the entity.
     *
     * //deorecated: Use the 'globalBounds' property instead.
     */
    //deorecated("Use the 'globalBounds' property instead.")
     ...
     * //deorecated: Use the 'globalBounds' property instead.
     */
    //deorecated("Use the 'localBounds' property instead.")
     ...
     *      newStyle = New style
     *
     * //deorecated: Use the 'style' property instead.
     */
    //deorecated("Use the 'style' property instead.")
     ...
     * 		text	= New string
     *
     * //deorecated: Use the 'string' property instead.
     */
    //deorecated("Use the 'string' property instead.")
